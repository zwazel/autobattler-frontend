...
export default function Profile(props: { user: User, unitTypes: UnitTypes[], units: Unit[] }) {
    const user = props.user;
    const unitTypes = props.unitTypes;
    const [units, setUnits] = useState<Unit[]>(props.units);
    ...
    return (
        <div>
            ...
            <p>
                You can create more
                units: {((user.maxAmountUnits < 0) || (amountUnits < user.maxAmountUnits)) ? "Yes" : "No"}
            </p>
            ...
            <table>
                ...
                {((user.maxAmountUnits < 0) || (amountUnits < user.maxAmountUnits)) ?
                    <tr>
                        <td>
