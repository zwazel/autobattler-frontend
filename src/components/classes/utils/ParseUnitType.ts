...
export default function ParseUnitType(unitType: UnitTypes, unitName: string, unitLevel: number, unitID?: number, unitSide?: Side, unitPos?: Position, dateCollected?: Date): Unit {
