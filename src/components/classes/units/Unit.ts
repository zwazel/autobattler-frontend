...
export default class Unit {
    ...
    constructor(name: string, level: number, image: string, type: UnitTypes, scaleAttributes: Function, id?: number, priority?: number, side?: Side, position?: Position, dateCollected?: string) {
        this._id = id || -1;
